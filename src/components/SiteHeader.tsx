...
export function SiteHeader() {
  ...
  return (
    <>
      {/* ---- bandeau utilitaire ---- */}
      <div className="bg-pine-950 text-pine-100">
        <div className="mx-auto flex h-11 w-full max-w-7xl items-center justify-between px-5 text-xs sm:px-8">
          <a
            href={phoneHref}
          ...
          <div className="hidden items-center gap-6 sm:flex">
            <span className="flex items-center gap-2">
              <ClipboardList className="h-3.5 w-3.5 text-pine-300" />
              Devis en 1 min
            </span>
            <span className="flex items-center gap-2">
              <Truck className="h-3.5 w-3.5 text-pine-300" />
